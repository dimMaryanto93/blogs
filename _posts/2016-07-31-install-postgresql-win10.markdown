...
![Pilihan install postgresql]({{ site.baseurl }}/images/2016-07/install-postgresql-win10/pg-download-1.png)
...
![Installer by BigSQL]({{ site.baseurl }}/images/2016-07/install-postgresql-win10/pg-download-2.png)
...
![Starting install PostgreSQL]({{ site.baseurl }}/images/2016-07/install-postgresql-win10/pg-install-1.png)

Kemudian klik **Next** untuk melanjutkan, setelah itu maka akan muncul form seperti berikut:

![Select location install postgresql]({{ site.baseurl }}/images/2016-07/install-postgresql-win10/pg-install-2.png)
...
![Pilih sql editor]({{ site.baseurl }}/images/2016-07/install-postgresql-win10/pg-install-3.png)
...
![Init data]({{ site.baseurl }}/images/2016-07/install-postgresql-win10/pg-install-4.png)
...
![]({{ site.baseurl }}/images/2016-07/install-postgresql-win10/pg-install-5.png)
...
![Konfirmasi konfigurasi postgresql]({{ site.baseurl }}/images/2016-07/install-postgresql-win10/pg-install-6.png)

Klo anda sudah yakin, langsung aja **Next** untuk menajukan ke proses Installasi seperti berikut:

![Progress install postgresql]({{ site.baseurl }}/images/2016-07/install-postgresql-win10/pg-install-7.png)

Setelah selesai, kita akan melihat tampilan seperti berikut:

![Finish install postgresql]({{ site.baseurl }}/images/2016-07/install-postgresql-win10/pg-install-8.png)
...
![Login command prompt]({{ site.baseurl }}/images/2016-07/install-postgresql-win10/pg-login-1.png)

Selain itu juga kita bisa menggunakan pgAdminIII berikut caranya:

buka dulu pgAdminIII, tampilanya seperti berikut:

![pgAdmin3]({{ site.baseurl }}/images/2016-07/install-postgresql-win10/pgadmin-1.png)
...
![Form new connection]({{ site.baseurl }}/images/2016-07/install-postgresql-win10/pgadmin-2.png)
...
![Form new connection]({{ site.baseurl }}/images/2016-07/install-postgresql-win10/pgadmin-3.png)

Jika sudah klik **OK** untuk meng-koneksikan dengan database dan user tersebut, klo sukses maka tampilanya seperti berikut:

![new connection available]({{ site.baseurl }}/images/2016-07/install-postgresql-win10/pgadmin-4.png)
...
![find local service]({{ site.baseurl }}/images/2016-07/install-postgresql-win10/pg-service-1.png)

Kemudian akan tampil konfigurasi seperti berikut:

![Local service]({{ site.baseurl }}/images/2016-07/install-postgresql-win10/pg-service-2.png)

setelah itu anda cari service namenya ```PostgreSQl 9.x Server``` seperti gambar berikut ini:

![PostgreSQL 9.x service]({{ site.baseurl }}/images/2016-07/install-postgresql-win10/pg-service-3.png)
...
![PostgreSQL 9.x server configurasi default]({{ site.baseurl }}/images/2016-07/install-postgresql-win10/pg-service-4.png)
...
![Manual service stated]({{ site.baseurl }}/images/2016-07/install-postgresql-win10/pg-service-5.png)
